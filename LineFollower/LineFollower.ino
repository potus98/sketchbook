...
////////////////////////////////////////////////////////////////////////
  ...
  if (error < -1000){            // the line is on the left (orig example was 500, try expanding range to soften waggle)
    Serial.println("Turn Left");
    //speedMotorLeft = 0;  // turn left
    driveForward(100, 50);
  }
  if (error > 1000){  // the line is on the right
    Serial.println("Turn Right");
    //speedMotorRight = 0;  // turn right
    driveForward(50, 100);
  }
  if (error >= -1000 && error <= 1000){  // if we're in the sweet spot
    Serial.println("Go Straight");
    driveForward(100, 100);
  }
  // set motor speeds using the two motor speed variables above
  //driveForward(speedMotorA, speedMotorB); // Did adding this line temporarily break my ability to upload sketches?
  // for very simple testing, just drive forward until "error" from line position
}
...
////////////////////////////////////////////////////////////////////////
  ...
  Serial.print(position);
  Serial.print("  ");
  //delay(150); // Remove this delay for final testing and actual competition
  ////////////////////////////////////////////////////////////////////////
  unsigned int sensors[8];
  // get calibrated sensor values returned in the sensors array, along with the line position
  // position will range from 0 to 7000, with 3000 corresponding to the line over sensor 4
